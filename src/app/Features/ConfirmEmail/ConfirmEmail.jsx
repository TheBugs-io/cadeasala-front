...
const ConfirmEmail = () => {
  ...
  useEffect(() => {
    ...
    axios
      .post(`${API_URL}/registro/confirmar`, { token })
  ...
  const renderMensagem = () => {
    switch (status) {
      ...
      case 'sucesso':
        return <p style={{ color: 'green' }}>✅ E-mail confirmado com sucesso!</p>;
      case 'erro':
        return <p style={{ color: 'red' }}>❌ Token inválido ou expirado.</p>;
      case 'invalido':
        return <p style={{ color: 'orange' }}>⚠️ Nenhum token fornecido na URL.</p>;
      default:
        return null;
    }
  };
